...
const userStates = {};
// In-memory storage for referral tracking
const referralData = {}; 
...
\\\
*Action:* Please process this payout manually.
            ✅ *Withdrawal Request Submitted!*\n\nWe have successfully received your request to withdraw *${withdrawalAmount.toFixed(2)} USDT* via ${paymentMethod}.\n\nThe payment will be processed to your provided details shortly. You can check your remaining balance with \.
